        ...
        while not self.endTransmission:
            ...
            for word in wordList:
                ...
                for char in word:
                    ...
                    if(morseCounter < message.length()-1) {
                        morseCounter++;
                        if(nextSymbol == dot) {
                            current = dotState;
                    ...
                    ## You should be able to accomplish this in fewer 
                    ## than 6 lines of code.
                    if(wordCounter < message.length()-1) {
                        wordCounter++;
                    else {
                ...
                ## You should be able to accomplish this in fewer 
                ## than 6 lines of code.
                if(wordCounter < messageWord.size() - 1) {
                    wordCounter++;
                    else {
                        currentState = endState;
                    }
...
## line of code.
greenButton.pressed = self.toggleMessage
